...
> Projektstatus: stabile Version. WOSM v0.2.0 ergänzt eine Benutzeroberfläche in fünf Sprachen, projektionsbewusste Importe, BetterID AI-Unterstützung für OSM-Änderungssatzkommentare und Verbesserungen am OSM-Bearbeitungsworkflow. Prüfe alle OpenStreetMap-Uploads vor dem Senden.

## Release

Die aktuelle stabile Version ist als selbstständiges Windows-x64-Paket verfügbar:

[WOSM v0.2.0 herunterladen](https://github.com/CAFEMDDSTEM/WPF-OpenStreetmap-Editor/releases/download/v0.2.0/WOSM-v0.2.0-win-x64.zip)

Prüfe die ZIP-Datei gegen [`SHA256SUMS-v0.2.0.txt`](https://github.com/CAFEMDDSTEM/WPF-OpenStreetmap-Editor/releases/download/v0.2.0/SHA256SUMS-v0.2.0.txt), bevor du dich bei OpenStreetMap anmeldest oder Änderungen hochlädst:
