...
> 專案狀態：正式版。WOSM v0.2.0 新增五語介面本地化、支援投影處理的匯入、BetterID AI 輔助 OSM 變更集註解，以及 OSM 編輯流程改進。送出任何 OpenStreetMap 上傳前請仔細檢查。

## 發行

最新正式版提供 Windows x64 自包含套件：

[下載 WOSM v0.2.0](https://github.com/CAFEMDDSTEM/WPF-OpenStreetmap-Editor/releases/download/v0.2.0/WOSM-v0.2.0-win-x64.zip)

登入 OpenStreetMap 或上傳變更前，請使用 [`SHA256SUMS-v0.2.0.txt`](https://github.com/CAFEMDDSTEM/WPF-OpenStreetmap-Editor/releases/download/v0.2.0/SHA256SUMS-v0.2.0.txt) 驗證 ZIP：
...
如果你有關於 WOSM 的問題、建議，或者希望參與專案開發，可以加入社群交流：

* QQ 群：1091805906
* Discord 群組：https://discord.gg/xJRG5uAET
