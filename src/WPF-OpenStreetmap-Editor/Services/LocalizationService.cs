...
public sealed class LocalizationService : INotifyPropertyChanged {
    ...
    private static readonly IReadOnlyDictionary<string, string> HeadlessEnglishStrings =
        new Dictionary<string, string>(StringComparer.Ordinal) {
            ...
            ["Settings.GpsPoints"] = "GPS points",
            ["Settings.GpsPointsDescription"] = "Settings that control GPS track drawing.",
            ["Settings.GpsDrawLinesBetweenPoints"] = "Draw lines between raw GPS points",
            ["Settings.GpsLineMinimumDistancePixels"] = "Minimum distance (pixels)",
            ["Settings.GpsDrawLargePoints"] = "Draw large GPS points",
            ["Settings.GpxTrackDrawingWidth"] = "GPX track drawing width",
            ["Settings.GpsTrackPointColors"] = "Track and point colors",
            ["Settings.GpsColorSingle"] = "Single color (can be customized in the layer manager)",
            ["Settings.GpsColorSpeed"] = "Speed (red = slow, green = fast)",
            ["Settings.GpsSpeedProfileCar"] = "Car",
            ["Settings.GpsSpeedProfileBicycle"] = "Bicycle",
            ["Settings.GpsSpeedProfileWalk"] = "Walk",
            ["Settings.GpsColorFixedValue"] = "GPS fixed value",
            ["Settings.GpsColorReferenceId"] = "GPS reference ID",
            ["Settings.GpsColorTimestamp"] = "Track timestamp",
            ["Settings.GpsColorHeatmap"] = "Heatmap (dark = few, bright = many)",
            ["Settings.GpsHeatmapBlendNormal"] = "Normal",
            ["Settings.GpsHeatmapBlendAdditive"] = "Additive",
            ["Settings.GpsHeatmapBlendMultiply"] = "Multiply",
            ["Settings.GpsHeatmapOverlayAdjustment"] = "Overlay adjustment",
            ["Settings.GpsHeatmapUseTargetColor"] = "Use target color in heatmap",
            ["Settings.GpsLineMinimumDistanceRequired"] = "Enter an integer minimum distance for GPS lines.",
            ["Settings.GpsTrackDrawingWidthRequired"] = "Enter a numeric GPX track drawing width.",
            ["Settings.GpsNonNegativeRequired"] = "GPS distances and widths cannot be negative.",
            ["Settings.FileBackup"] = "File backup",
            ["Settings.EnableAutosave"] = "Enable autosave",
            ["Settings.AutosaveIntervalSeconds"] = "Autosave interval (seconds)",
            ["Settings.AutosaveFilesPerLayer"] = "Autosave files per layer",
            ["Settings.AutosaveHelp"] = "Autosave periodically writes unsaved map changes to backup files in WOSM's local backup folder.",
            ["Settings.KeepBackupFileOnSave"] = "Keep a backup file when saving data",
            ["Settings.KeepBackupHelp"] = "When saving data, WOSM keeps a copy of the previous file in the same folder with a trailing \"~\" in the file name.",
            ["Settings.NotifyOnEverySave"] = "Notify on every save",
            ["Settings.AutosaveIntervalRange"] = "Autosave interval must be an integer from {0} through {1} seconds.",
            ["Settings.AutosaveFilesPerLayerRange"] = "Autosave files per layer must be an integer from {0} through {1}.",
            ["Main.Status.Autosaved"] = "Autosaved {0}.",
            ["Main.Status.AutosaveFailed"] = "Autosave failed: {0}"
        };
