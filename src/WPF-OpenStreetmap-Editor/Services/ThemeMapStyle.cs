...
public sealed class ThemeMapStyle {
    ...
    private static ThemeMapStyle CreateLightDefault() {
        return new ThemeMapStyle {
            ...
            SecondaryRoad = new ThemeLineStyle { Stroke = "#F7FABF", Casing = "#707D05", StrokeWidth = 2.8, CasingWidth = 4.6 },
            PrimaryRoad = new ThemeLineStyle { Stroke = "#FCD6A4", Casing = "#A06B00", StrokeWidth = 3.4, CasingWidth = 5.2 },
            Motorway = new ThemeLineStyle { Stroke = "#E892A2", Casing = "#DC2A67", StrokeWidth = 4.0, CasingWidth = 6.0 },
    ...
    private static ThemeMapStyle CreateDarkDefault() {
        return new ThemeMapStyle {
            ...
            SecondaryRoad = new ThemeLineStyle { Stroke = "#F2D46B", Casing = "#7A6943", StrokeWidth = 2.8, CasingWidth = 4.6 },
            PrimaryRoad = new ThemeLineStyle { Stroke = "#F3A65E", Casing = "#815837", StrokeWidth = 3.4, CasingWidth = 5.2 },
            Motorway = new ThemeLineStyle { Stroke = "#FF7F92", Casing = "#894654", StrokeWidth = 4.0, CasingWidth = 6.0 },
